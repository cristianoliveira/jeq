...
## Acceptance criteria
- [ ] Add a small standard-library Python `gev` subprocess adapter that preserves structured output, stderr, and exit status without becoming an orchestration DSL.
...
- [ ] Operational gev failures retain their structured document and 1/2/130 status; policy outcomes use documented non-conflicting statuses.

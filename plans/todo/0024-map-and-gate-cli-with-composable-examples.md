...
## Acceptance criteria
- [ ] `gev map --as <name> --questions <file> [--state-pointer <RFC6901>]` accepts JSON or NDJSON, sequentially enriches each object under `_gev.<name>`, preserves order, and emits the same framing.

...
- [ ] Make each workflow recipe a real child of `jeq examples`. Bare `jeq examples` equals `jeq examples --help`; each bare recipe equals its `--help`. Parent lists recipes through Cobra `Available Commands`.
